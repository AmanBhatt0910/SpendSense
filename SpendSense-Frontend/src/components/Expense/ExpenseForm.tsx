      ...
      <div className="text-center">
        {!showForm ? (
          <button
            ...
            className="bg-primary text-white py-2 px-4 rounded-full shadow-lg hover:bg-primary-dark transition-all"
          >
            Add Expense
          </button>
        ) : (
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-lg space-y-4 transition-all">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="w-full py-2 bg-primary text-white rounded-lg shadow-lg hover:bg-primary-dark transition-all"
            >
              Add Expense
            </button>
          </div>
